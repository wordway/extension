    ...
    <>
      ...
      <List>
              ...
              <>
                {config?.selectionTranslateMode !== 'disabled' && (
                  ...
                  >
                    ...
                    <Radio style={radioStyle} value="enable-translate-tooltip">
                      显示弹出式翻译
                      <Text type="secondary" style={radioSummaryStyle}>
        ...
        <List.Item>
          <List.Item.Meta
            title="快捷键"
            description={'当弹出翻译未启用时，你可以通过快捷键触发弹出翻译。'}
          />
          <Select
          ...
          >
            ...
            <Select.Option value="double_command">Double Command</Select.Option>
          </Select>
        </List.Item>
        <List.Item>
